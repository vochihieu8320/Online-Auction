...
// Import Image
import { Clients_08,Clients_02,Clients_03,Img_01 } from '../imagepath';
                ...
                <div className="comp-sec-wrapper">
                    ...
                    <div className="row">
                        ...
                        <div className="card">
                          ...
                          <div className="card-body">
                            <div className="avatar avatar-xxl">
                              <img className="avatar-img rounded-circle" alt="User Image" src={Clients_08} />
                            </div>
                      ...
                      <div className="col-md-12">
                        <div className="card">
                          ...
                          <div className="card-body">
                            <div className="avatar">
                              <img className="avatar-img rounded" alt="User Image" src={Clients_08} />
                            </div>
                            <div className="avatar">
                              <img className="avatar-img rounded-circle" alt="User Image" src={Clients_08} />
                            </div>
                        ...
                        <div className="card">
                          ...
                          <div className="card-body">
                            <div className="avatar-group">
                              <div className="avatar">
                                <img className="avatar-img rounded-circle border border-white" alt="User Image" src={Clients_08} />
                              </div>
                              <div className="avatar">
                                <img className="avatar-img rounded-circle border border-white" alt="User Image" src={Clients_02} />
                              </div>
                              <div className="avatar">
                                <img className="avatar-img rounded-circle border border-white" alt="User Image" src={Clients_03} />
                              </div>
                              <div className="avatar">
                  ...
                  <section className="comp-section comp-buttons">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        <button type="button" className="btn btn-rounded btn-primary mr-0">Primary</button>
                        <button type="button" className="btn btn-rounded btn-secondary mr-0">Secondary</button>
                        <button type="button" className="btn btn-rounded btn-success mr-0">Success</button>
                        <button type="button" className="btn btn-rounded btn-danger mr-0">Danger</button>
                        <button type="button" className="btn btn-rounded btn-warning mr-0">Warning</button>
                        <button type="button" className="btn btn-rounded btn-info mr-0">Info</button>
                        <button type="button" className="btn btn-rounded btn-light mr-0">Light</button>
                        ...
                        <button type="button" className="btn btn-rounded btn-outline-primary mr-0">Primary</button>
                        <button type="button" className="btn btn-rounded btn-outline-secondary mr-0">Secondary</button>
                        <button type="button" className="btn btn-rounded btn-outline-success mr-0">Success</button>
                        <button type="button" className="btn btn-rounded btn-outline-danger mr-0">Danger</button>
                        <button type="button" className="btn btn-rounded btn-outline-warning mr-0">Warning</button>
                        <button type="button" className="btn btn-rounded btn-outline-info mr-0">Info</button>
                        <button type="button" className="btn btn-rounded btn-outline-light mr-0">Light</button>
